from flask import Flask, flash, request, render_template, redirect, url_for, flash, abort
...
def get_all_posts():
    ...
    return render_template("index.html", all_posts=posts,curr_user=current_user)
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        requested_post.comment = form.comment_text.data
        db.session.add()
        db.session.commit()
        return redirect(url_for("get_all_posts"))
